...
/** Função booleana que verifica se o último comando executado goi o pos.*/
...
/** Função que verifica se a peça branca está presa e se sim devolve 1, senão retorna 0.*/
