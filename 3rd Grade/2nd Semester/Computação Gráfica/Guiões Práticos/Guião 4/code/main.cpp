...
void generate_cylinder(float radius, float height,int slices){
	vertexB.clear();
	...
	for (int i = 0; i < slices; i++) {
		...
		vertexB.push_back(cos(i * angle * M_PI / 180.0)*radius);
		vertexB.push_back(height*0.5);
		vertexB.push_back(-sin(i * angle *M_PI / 180.0)*radius);

		vertexB.push_back(cos((i + 1) * angle * M_PI / 180.0)*radius);
		vertexB.push_back(height*0.5);
		vertexB.push_back(-sin((i + 1) * angle *M_PI / 180.0)*radius);
	}
