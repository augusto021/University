...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{sheet2html}\;(\Conid{Rect}\;(\Conid{Frame}\;\Varid{w}\;\Varid{h})\;\Varid{y})\mathrel{=}\Varid{htmlwrap}\;(\Varid{new\char95 x2html}\;\Varid{y}\;(\Varid{w},\Varid{h})){}\<[E]%
\\[\blanklineskip]%
...
%
        \ensuremath{\begin{lcbr}\Varid{inNEList}\comp i_1\mathrel{=}\Varid{singl}\\\Varid{inNEList}\comp i_2\mathrel{=}\Varid{cons}\end{lcbr}}
%
\just\equiv{\textcolor{blue}{Igualdade\ Extensional\ (71),\ Def-comp\ (72)}}
%
      \ensuremath{\begin{lcbr}\Varid{inNEList}\;(i_1\;\Varid{a})\mathrel{=}\Varid{singl}\;\Varid{a}\\\Varid{inNEList}\;(i_2\;(\Varid{h},\Varid{t}))\mathrel{=}\Varid{cons}\;(\Varid{h},\Varid{t})\end{lcbr}}
\end{eqnarray*}
...
%
      \ensuremath{\begin{lcbr}\Varid{outNEList}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}i_1\;\Varid{a}\\\Varid{outNEList}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}i_2\;(\Varid{h},\Varid{t})\end{lcbr}}
\end{eqnarray*}
...
\centerline{\xymatrix{
   NEList A \ar[d]_-{\ensuremath{\Varid{f}}}
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{outNEList}}} & \qquad \cong
&   A + (A \times NEList A)  \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{f}}}
                                     \ar@/^2pc/ [ll]^-{\ensuremath{\Varid{inNEList}}}
\\
    \ensuremath{\Conid{C}} &  & A + (A \times C)\ar[ll]
}}
...
\fbox{\begin{minipage}{20em}
    \center $ \ensuremath{\Varid{g\char95 list2LTree}\mathrel{=}\Varid{id}\mathbin{+}\Varid{singl}\times\Varid{id}\comp \Varid{outNEList}} $
\end{minipage}}
\end{center}
...
\fbox{\begin{minipage}{9em}
    \center $ \ensuremath{\Varid{g\char95 list2LTree}\mathrel{=}\Varid{lsplit}} $
\end{minipage}}
\end{center}
...
&   
     A + (LTree A \times LTree A)  
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{lTree2MTree}\times\Varid{lTree2MTree})}}
          \ar@/^2pc/ [ll]^-{\ensuremath{\mathsf{in}}}
\\
    \ensuremath{{\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A})} 
&  
& 
     A + (\ensuremath{{\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A})} \times \ensuremath{{\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A})})
...
Vamos começar por definir \textit{g\_lTree2MTree} = \ensuremath{[\mskip1.5mu \Varid{g1},\Varid{g2}\mskip1.5mu]}.

Ao executar o \textit{outLTree}, o "caso da esquerda" é um elemento que corresponde a uma folha que neste momento apenas possui a tarnsação "a" e que é preservada pela função \textit{id}. Assim, a função \ensuremath{\Varid{g1}} recebe uma tarnsação "a" e precisa criar um par em que o primeiro elemento é \textit{hash a} e o segundo é a própria tarnsação "a":

\xymatrixcolsep{2pc}\xymatrixrowsep{2pc}
\centerline{\xymatrix {
    A 
          \ar[r]^-{\ensuremath{\conj{\Varid{id}}{\Varid{id}}}} 
&
    (A,A) 
          \ar [r]^-{\ensuremath{\Varid{hash}\times\Varid{id}}}
&
    \ensuremath{(\mathbb{Z},\Conid{A})} 
          \ar [rr]^-{inFTree . i1}
&
&
    \ensuremath{\Conid{Unit}\;(\mathbb{Z},\Conid{A})} 
}}
...
\begin{eqnarray*}
\start
  \ensuremath{\Varid{g1}\mathrel{=}\mathsf{in}\comp i_1\comp (\Varid{hash}\times\Varid{id})\comp \conj{\Varid{id}}{\Varid{id}}} 
%
\just\equiv{\textcolor{blue}{Absorção-x (11), Natural-id (1)}}
%
  \ensuremath{\Varid{g1}\mathrel{=}\mathsf{in}\comp i_1\comp \conj{\Varid{hash}}{\Varid{id}}}
%
\just\equiv{\textcolor{blue}{Definição inFTree}}
%
  \ensuremath{\Varid{g1}\mathrel{=}[\mskip1.5mu \Conid{Unit},\uncurry{\Conid{Comp}}\mskip1.5mu]\comp \conj{\Varid{hash}}{\Varid{id}}}
%
\just\equiv{\textcolor{blue}{Cancelamento-+(18)}}
%
  \ensuremath{\Varid{g1}\mathrel{=}\Conid{Unit}\comp \conj{\Varid{hash}}{\Varid{id}}}
\end{eqnarray*}
...
\fbox{\begin{minipage}{11em}
    \center $ \ensuremath{\Varid{g1}\mathrel{=}\Conid{Unit}\comp \conj{\Varid{hash}}{\Varid{id}}} $
\end{minipage}}
\end{center}

\vspace{0.5cm}

\par\noindent\hspace{0.5cm}Relativamente ao \ensuremath{\Varid{g2}}, a função trata do caso em que a árvore não é uma folha mas uma ramificação \textit{Fork}. Assim, aplicando recursivamente a função \textit{lTree2MTree} ao par \textit{(LTree A, LTree A)}, resultante da ramificação devolvida pela função \textit{outLTree} obtém-se outro par \textit{(\ensuremath{{\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A}),{\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A}))}}. Por fim, resta a função \ensuremath{\Varid{g2}} juntar essas sub árvores numa  só, concatenando a informação desses nodos e guardando no nodo do pai.
...
\centerline{\xymatrix {
    \ensuremath{{\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A})} 
          \ar[d]_{\ensuremath{\conj{\Varid{auxConcHash}}{\Varid{id}}}} \\
    \ensuremath{(\mathbb{Z},({\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A}),{\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A})))} 
          \ar [d]_{\ensuremath{\mathsf{in}\comp i_2\mathrel{=}\uncurry{\Conid{Comp}}}} \\
    \ensuremath{{\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A})} \\
}}
...
\fbox{\begin{minipage}{15em}
    \center $ \ensuremath{\Varid{g2}\mathrel{=}\uncurry{\Conid{Comp}}\comp \conj{\Varid{auxConcHash}}{\Varid{id}}} $
\end{minipage}}
\end{center}
...
\centerline{\xymatrix{
     \ensuremath{{\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A})} 
          \ar[d]_-{\ensuremath{\Varid{mroot}}}
          \ar@/^2pc/ [rr]^-{\ensuremath{\mathsf{out}}} & \qquad \cong
&   
     \ensuremath{(\mathbb{Z},\Conid{A})\mathbin{+}(\mathbb{Z}\times({\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Conid{A})})^2)  
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times}mroot^2}
          \ar@/^2pc/ [ll]^-{\ensuremath{\mathsf{in}}}
\\
    \ensuremath{\mathbb{Z}} 
&  
& 
     \ensuremath{(\mathbb{Z},\Conid{A})\mathbin{+}(\mathbb{Z}\times(\mathbb{Z}\times\mathbb{Z})})
          \ar[ll]^-{\ensuremath{\Varid{g\char95 mroot}}}
}}

\vspace{0.5cm}

\par\noindent\hspace{0.5cm}Nesta função quando o bloco [b] tem apenas uma transação a \textit{Merkle root} esta no primeiro elemento do par \ensuremath{(\mathbb{Z},\Conid{A})} gerado à esquerda. 

\vspace{0.5cm}

\begin{center}
\fbox{\begin{minipage}{11em}
    \center $ \ensuremath{\Conid{Assim},\Varid{g\char95 mroot}\mathrel{=}[\mskip1.5mu \p1,\mathbin{?}\mskip1.5mu]} $
\end{minipage}}
\end{center}

\vspace{0.5cm}

\par\noindent\hspace{0.5cm}Quando a árvore não é apenas uma folha a \textit{Merkle root} está no nodo da raiz que é o primeiro elemento do par \ensuremath{(\mathbb{Z},(\mathbb{Z},\Conid{A}))} gerado à direita, pelo que

\vspace{0.5cm}

\begin{center}
\fbox{\begin{minipage}{11em}
    \center $ \ensuremath{\Varid{g\char95 mroot}\mathrel{=}[\mskip1.5mu \p1,\p1\mskip1.5mu]} $
\end{minipage}}
\end{center}
...
\begin{center}
\fbox{\begin{minipage}{9em}
    \center $ \ensuremath{\Varid{g\char95 mroot}\mathrel{=}\Varid{firsts}} $
\end{minipage}}
\end{center}
...
De seguida, decompomos a lista pela respetiva cabeça e cauda (h,t) e aplicamos \textit{\ensuremath{\Varid{dux}\times\Varid{id}}} que tranforma a cabeça (h) no par (h,h) e preserva a cauda.
...
\fbox{\begin{minipage}{27em}
    \center $ \ensuremath{\Varid{g\char95 pairsList}\mathrel{=}(\Varid{id}\mathbin{+}\Varid{pair\char95 aux}\comp (\Varid{dup}\times\Varid{id}))\comp \Varid{outList}\comp \Varid{getEvenBlock}} $
\end{minipage}}
\end{center}
...
\\[\blanklineskip]%
\>[B]{}\Varid{baseNEList}\;\Varid{g}\;\Varid{f}\mathrel{=}\Varid{id}+\Varid{g}\times\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recNEList}\;\Varid{f}\mathrel{=}\Varid{baseNEList}\;\Varid{id}\;\Varid{f}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 list2LTree}\mathrel{=}\Varid{lsplit}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{g\char95 lTree2MTree}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g1}\mathrel{=}\Conid{Unit}\comp \conj{\Varid{\Conid{Main}.hash}}{\Varid{id}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g2}\mathrel{=}\uncurry{\Conid{Comp}}\comp \conj{\Varid{auxConcHash}}{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\newline
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{auxConcHash}\mathbin{::}({\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Varid{b1}),{\FTree}\;\mathbb{Z}\;(\mathbb{Z},\Varid{b2}))\to \mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{auxConcHash}\;(\Conid{Unit}\;(\Varid{a},\anonymous ),\Conid{Unit}\;(\Varid{b},\anonymous ))\mathrel{=}\Varid{concHash}\;(\Varid{a},\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{auxConcHash}\;(\Conid{Unit}\;(\Varid{a},\anonymous ),\Conid{Comp}\;\Varid{b}\;(\anonymous ,\anonymous ))\mathrel{=}\Varid{concHash}\;(\Varid{concHash}\;(\Varid{a},\Varid{a}),\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{auxConcHash}\;(\Conid{Comp}\;\Varid{a}\;(\anonymous ,\anonymous ),\Conid{Unit}\;(\Varid{b},\anonymous ))\mathrel{=}\Varid{concHash}\;(\Varid{a},\Varid{concHash}\;(\Varid{b},\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{auxConcHash}\;(\Conid{Comp}\;\Varid{a}\;(\anonymous ,\anonymous ),\Conid{Comp}\;\Varid{b}\;(\anonymous ,\anonymous ))\mathrel{=}\Varid{concHash}\;(\Varid{a},\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\Varid{pairsList}\mathrel{=}\anaList{\Varid{g\char95 pairsList}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g\char95 pairsList}\mathrel{=}(\Varid{id}+\Varid{pair\char95 aux}\comp (\Varid{dup}\times\Varid{id}))\comp \Varid{outList}\comp \Varid{getEvenBlock}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{pair\char95 aux}\;((h_1 ,h_2 ),\Varid{t})\mathrel{=}((h_1 ,\Varid{head}\;\Varid{t}),\Varid{tail}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{classicMerkleTree}\mathbin{::}\Conid{Hashable}\;\Varid{a}\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to {\FTree}\;\mathbb{Z}\;\mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{classicMerkleTree}\mathrel{=}\Varid{hyloNEList}\;\Varid{conquer}\;\Varid{divide}\comp \map \;\Varid{\Conid{Main}.hash}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divide}\mathrel{=}((\Varid{singl}\comp \Conid{Unit})+\Varid{createMtree})\comp \Varid{outNEList}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{createMtree}\mathrel{=}\Varid{singl}\comp \Conid{Unit}\times\Varid{id}{}\<[E]%
\\[\blanklineskip]%
...
\begin{eqnarray*}
\start
     \ensuremath{\conj{\Varid{wc\char95 c}}{\Varid{lookahead\char95 sep}}\mathrel{=}}\cata{\ensuremath{\conj{\Varid{h}}{\Varid{k}}}}
%
\just\equiv{\textcolor{blue}{Definições de h e k}}
%
     \ensuremath{\conj{\Varid{wc\char95 c}}{\Varid{lookahead\char95 sep}}\mathrel{=}}\cata{\ensuremath{\conj{\alt{h_1 }{h_2 }}{\alt{k_1 }{k_2 }}}}
%
\just\equiv{ \textcolor{blue}{Lei da Troca (28)}}
%
     \ensuremath{\conj{\Varid{wc\char95 c}}{\Varid{lookahead\char95 sep}}\mathrel{=}}\cata{\ensuremath{\alt{\conj{h_1 }{k_1 }}{\conj{h_2 }{k_2 }}}}
\end{eqnarray*}
...
\fbox{\begin{minipage}{13em}
    \center $ \ensuremath{\Varid{worker}\mathrel{=}}\cata{\ensuremath{\alt{\conj{h_1 }{k_1 }}{\conj{h_2 }{k_2 }}}} $
\end{minipage}}
\end{center}

que por sua vez:
\begin{eqnarray*}
     \ensuremath{\begin{lcbr}\Varid{g1}\mathrel{=}\conj{h_1 }{k_1 }\\\Varid{g2}\mathrel{=}\conj{h_2 }{k_2 }\end{lcbr}}
\end{eqnarray*}
...
\centerline{\xymatrix@C=3cm@R=2cm{
    Char^*
          \ar[d]_-{\ensuremath{\Varid{lookahead\char95 sep}}}
...
Concluindo, assim, a seguinte definição de \ensuremath{h_2 }:

\begin{center}
\fbox{\begin{minipage}{5em}
    \center $ \ensuremath{h_2 \mathrel{=}\Varid{aux}} $
\end{minipage}}
\end{center}
...
\fbox{\begin{minipage}{21em}
    \center $ \ensuremath{\Varid{aux}\;(\Varid{c},(\Varid{i},\Varid{b}))\mathrel{=}\mathbf{if}\;\neg \;(\Varid{sp}\;\Varid{c})\mathrel{\wedge}\Varid{b}\;\mathbf{then}\;\Varid{i}\mathbin{+}\mathrm{1}\;\mathbf{else}\;\Varid{i}} $
\end{minipage}}
\end{center}
...
\\
\>[B]{}h_2 \mathrel{=}\Varid{aux}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{aux}\;(\Varid{c},(\Varid{i},\Varid{b}))\mathrel{=}\mathbf{if}\;\neg \;(\Varid{sp}\;\Varid{c})\mathrel{\wedge}\Varid{b}\;\mathbf{then}\;\Varid{i}\mathbin{+}\mathrm{1}\;\mathbf{else}\;\Varid{i}{}\<[E]%
\\
...
\begin{center}
\fbox{\begin{minipage}{13em}
    \center $ \ensuremath{\Varid{g\char95 x2html}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}} $
    \center $ \ensuremath{\Varid{g1}\mathrel{=}\Varid{auxX1}} $
    \center $ \ensuremath{\Varid{g2}\mathrel{=}\Varid{auxX2}} $
\end{minipage}}
\end{center}
...
\fbox{\begin{minipage}{17em}
    \center $ \ensuremath{\Varid{auxX1}\;(\Conid{Image}\;\Varid{a})\;(\Varid{w},\Varid{h})\mathrel{=}\Varid{img}\;\Varid{w}\;\Varid{h}\;\Varid{a}} $
    \center $ \ensuremath{\Varid{auxX1}\;(\Conid{Text}\;\Varid{b})\;\anonymous \mathrel{=}\Varid{b}} $
\end{minipage}}
\end{center}
...
\fbox{\begin{minipage}{35em}
     \center $ \ensuremath{\Varid{auxX2}\;(\Conid{Vt}\;\Varid{i},(\Varid{s1},\Varid{s2}))\;(\Varid{w},\Varid{h})\mathrel{=}\Varid{htab}\;\Varid{w}\;\Varid{h}\;(\Varid{tr}\;(\Varid{td}\;\Varid{w}\;(\Varid{h}\mathbin{*}\Varid{i})\;(\Varid{s1}\;(\Varid{w},\Varid{h}\mathbin{*}\Varid{i})))\mathbin{+\!\!\!+}\Varid{tr}\;(\Varid{td}\;\Varid{w}\;(\Varid{h}\mathbin{*}(\mathrm{1}\mathbin{-}\Varid{i}))\;(\Varid{s2}\;(\Varid{w},\Varid{h}\mathbin{*}(\mathrm{1}\mathbin{-}\Varid{i})))))} $
     \center $ \ensuremath{\Varid{auxX2}\;(\Conid{Hl}\;\Varid{i},(\Varid{s1},\Varid{s2}))\;(\Varid{w},\Varid{h})\mathrel{=}\Varid{htab}\;\Varid{w}\;\Varid{h}\;(\Varid{tr}\;(\Varid{td}\;(\Varid{w}\mathbin{*}\Varid{i})\;\Varid{h}\;(\Varid{s1}\;(\Varid{w}\mathbin{*}\Varid{i},\Varid{h}))\mathbin{+\!\!\!+}\Varid{td}\;(\Varid{w}\mathbin{*}(\mathrm{1}\mathbin{-}\Varid{i}))\;\Varid{h}\;(\Varid{s2}\;(\Varid{w}\mathbin{*}(\mathrm{1}\mathbin{-}\Varid{i}),\Varid{h}))))} $
     \center $ \ensuremath{\Varid{auxX2}\;(\Conid{Vb}\;\Varid{i},(\Varid{s1},\Varid{s2}))\;\Varid{m}\mathrel{=}\Varid{auxX2}\;(\Conid{Vt}\;(\mathrm{1}\mathbin{-}\Varid{i}),(\Varid{s1},\Varid{s2}))\;\Varid{m}} $
     \center $ \ensuremath{\Varid{auxX2}\;(\Conid{Hr}\;\Varid{i},(\Varid{s1},\Varid{s2}))\;\Varid{m}\mathrel{=}\Varid{auxX2}\;(\Conid{Hl}\;(\mathrm{1}\mathbin{-}\Varid{i}),(\Varid{s1},\Varid{s2}))\;\Varid{m}} $
\end{minipage}}
\end{center}
...
\\
\>[B]{}\Varid{inX}\;(i_1\;\Varid{u})\mathrel{=}\Conid{XLeaf}\;\Varid{u}{}\<[E]%
\\
\>[B]{}\Varid{inX}\;(i_2\;(\Varid{i},(\Varid{l},\Varid{r})))\mathrel{=}\Conid{Node}\;\Varid{i}\;\Varid{l}\;\Varid{r}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outX}\mathbin{::}\Conid{X}\;\Varid{a1}\;\Varid{a2}\to \Varid{a1}+(\Varid{a2},(\Conid{X}\;\Varid{a1}\;\Varid{a2},\Conid{X}\;\Varid{a1}\;\Varid{a2})){}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{anaX}\;\Varid{g}\mathrel{=}\Varid{inX}\comp \Varid{recX}\;(\Varid{anaX}\;\Varid{g})\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloX}\;\Varid{c}\;\Varid{d}\mathrel{=}\Varid{c}\comp \Varid{recX}\;(\Varid{cataX}\;\Varid{c})\comp \Varid{recX}\;(\Varid{anaX}\;\Varid{d})\comp \Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{new\char95 printJournal}\mathrel{=}\Varid{write}\comp \Varid{new\char95 sheet2html}{}\<[E]%
\\
\>[B]{}\Varid{new\char95 sheet2html}\;(\Conid{Rect}\;(\Conid{Frame}\;\Varid{w}\;\Varid{h})\;\Varid{y})\mathrel{=}\Varid{htmlwrap}\;(\Varid{new\char95 x2html}\;\Varid{y}\;(\Varid{w},\Varid{h})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{new\char95 x2html}\mathbin{::}\Conid{X}\;(\Conid{Unit}\;\Conid{String}\;\Conid{String})\;(\Conid{Mode}\;\Conid{Double})\to (\Conid{Double},\Conid{Double})\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{new\char95 x2html}\mathrel{=}\Varid{cataX}\;\Varid{g\char95 x2html}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g\char95 x2html}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g1}\mathrel{=}\Varid{auxX1}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g2}\mathrel{=}\Varid{auxX2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxX1}\;(\Conid{Image}\;\Varid{a})\;(\Varid{w},\Varid{h})\mathrel{=}\Varid{img}\;\Varid{w}\;\Varid{h}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{auxX1}\;(\Conid{Text}\;\Varid{b})\;\anonymous \mathrel{=}\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxX2}\;(\Conid{Vt}\;\Varid{i},(\Varid{s1},\Varid{s2}))\;(\Varid{w},\Varid{h})\mathrel{=}\Varid{htab}\;\Varid{w}\;\Varid{h}\;({}\<[E]%
\\
\>[B]{}\hsindent{38}{}\<[38]%
\>[38]{}\Varid{tr}\;(\Varid{td}\;\Varid{w}\;(\Varid{h}\mathbin{*}\Varid{i})\;{}\<[57]%
\>[57]{}(\Varid{s1}\;(\Varid{w},\Varid{h}\mathbin{*}\Varid{i})))\mathbin{+\!\!\!+}{}\<[E]%
\\
\>[B]{}\hsindent{38}{}\<[38]%
\>[38]{}\Varid{tr}\;(\Varid{td}\;\Varid{w}\;(\Varid{h}\mathbin{*}(\mathrm{1}\mathbin{-}\Varid{i}))\;(\Varid{s2}\;(\Varid{w},\Varid{h}\mathbin{*}(\mathrm{1}\mathbin{-}\Varid{i})))){}\<[E]%
\\
\>[B]{}\hsindent{36}{}\<[36]%
\>[36]{}){}\<[36E]%
\\
\>[B]{}\Varid{auxX2}\;(\Conid{Hl}\;\Varid{i},(\Varid{s1},\Varid{s2}))\;(\Varid{w},\Varid{h})\mathrel{=}\Varid{htab}\;\Varid{w}\;\Varid{h}\;({}\<[E]%
\\
\>[B]{}\hsindent{38}{}\<[38]%
\>[38]{}\Varid{tr}\;(\Varid{td}\;(\Varid{w}\mathbin{*}\Varid{i})\;\Varid{h}\;{}\<[57]%
\>[57]{}(\Varid{s1}\;(\Varid{w}\mathbin{*}\Varid{i},\Varid{h}))\mathbin{+\!\!\!+}{}\<[E]%
\\
\>[38]{}\hsindent{4}{}\<[42]%
\>[42]{}\Varid{td}\;(\Varid{w}\mathbin{*}(\mathrm{1}\mathbin{-}\Varid{i}))\;\Varid{h}\;(\Varid{s2}\;(\Varid{w}\mathbin{*}(\mathrm{1}\mathbin{-}\Varid{i}),\Varid{h}))){}\<[E]%
\\
\>[B]{}\hsindent{36}{}\<[36]%
\>[36]{}){}\<[36E]%
\\
\>[B]{}\Varid{auxX2}\;(\Conid{Vb}\;\Varid{i},(\Varid{s1},\Varid{s2}))\;\Varid{m}\mathrel{=}\Varid{auxX2}\;(\Conid{Vt}\;(\mathrm{1}\mathbin{-}\Varid{i}),(\Varid{s1},\Varid{s2}))\;\Varid{m}{}\<[E]%
\\
\>[B]{}\Varid{auxX2}\;(\Conid{Hr}\;\Varid{i},(\Varid{s1},\Varid{s2}))\;\Varid{m}\mathrel{=}\Varid{auxX2}\;(\Conid{Hl}\;(\mathrm{1}\mathbin{-}\Varid{i}),(\Varid{s1},\Varid{s2}))\;\Varid{m}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&    \qquad \cong
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times\Conid{A})\times(\Conid{A}\times\Conid{A})}^*
          \ar@/^2pc/[ll]_-{\ensuremath{\Varid{inX}}}
\\
     \ensuremath{\Conid{A}}^*
          \ar[u]^-{\ensuremath{\Varid{pairL}}}
          \ar[r]^-{\ensuremath{\Varid{outList}}}
          \ar@/^-2pc/[rr]_-{\ensuremath{\Varid{g}}}
&  
     1 + \ensuremath{\Conid{A}\times} A^*
          \ar[r]^-{\ensuremath{\Varid{id}\mathbin{+}\mathbin{?}}}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times\Conid{A})\times\Conid{A}}^*
           \ar[u]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{pairL}}}
}
}
\end{eqnarray*}
...
\centerline{\xymatrix@C=3cm@R=2cm{
     (A,A)^*
         \ar[r]_-{\ensuremath{\Varid{dup}\times\Varid{id}}}
&    \ensuremath{(\Conid{A},\Conid{A})\times\Conid{A}}^*
          \ar[r]_-{\ensuremath{\Varid{completePair}}}
&
     \ensuremath{(\Conid{A},\Conid{A})\times\Conid{A}}^*
}
}
...
\begin{center}
\fbox{\begin{minipage}{20em}
    \center $ \ensuremath{\Varid{g}\mathrel{=}(\Varid{id}\mathbin{+}\Varid{completePair}\comp (\Varid{dup}\times\Varid{id}))\comp \Varid{outList}} $
\end{minipage}}
\end{center}
...
\fbox{\begin{minipage}{12em}
    $ \ensuremath{\Varid{pairL}\mathrel{=}(\Varid{p}\to \Varid{f},\Varid{h})} $ \\
    $ \ensuremath{\mathbf{where}\;\Varid{p}\;\Varid{l}\mathrel{=}\length \;\Varid{l}\mathbin{>}\mathrm{1}} $\\
    $ \ensuremath{\Varid{f}\mathrel{=}\Varid{init}\comp \anaList{\Varid{g}}} $\\
    $ \ensuremath{\Varid{h}\mathrel{=}\anaList{\Varid{g}}} $
\end{minipage}}
\end{center}
...
\begin{eqnarray*}
\centerline{\xymatrix@C=3cm@R=2cm{
     (\ensuremath{\alt{\Conid{Pos}}{\Conid{Pos}}},h)^*
          \ar[r]_-{\ensuremath{\conj{\p1}{\Varid{toCell}}\times\Varid{id}}}
&    \ensuremath{(\Conid{Pos},\Conid{Cell}),\Varid{h}}
          \ar[r]_-{\ensuremath{\Varid{substCell}}}
&
    \ensuremath{\Conid{Map}}
}
}
...
\begin{center}
\fbox{\begin{minipage}{20em}
    \center $ \ensuremath{f_2 \mathrel{=}\Varid{substCell}\comp (\conj{\p1}{\uncurry{\Varid{toCell}}}\times\Varid{id})} $
\end{minipage}}
\end{center}
...
\\
\>[B]{}\Varid{pairL}\mathrel{=}\Varid{cond}\;\Varid{p}\;\Varid{f}\;\Varid{h}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{p}\;\Varid{l}\mathrel{=}\length \;\Varid{l}\mathbin{>}\mathrm{1}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\mathrel{=}\Varid{init}\comp \anaList{\Varid{g\char95 pairL}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\mathrel{=}\anaList{\Varid{g\char95 pairL}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g\char95 pairL}\mathrel{=}(\Varid{id}+\Varid{completePair}\comp (\Varid{dup}\times\Varid{id}))\comp \Varid{outList}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{3}{}\<[6]%
\>[6]{}\Varid{completePair}\;((\Varid{x1},\Varid{x2}),\Varid{l})\mathrel{=}\mathbf{if}\;\length \;\Varid{l}\mathbin{>}\mathrm{0}\;\mathbf{then}\;((\Varid{x1},\Varid{head}\;\Varid{l}),\Varid{l})\;\mathbf{else}\;((\Varid{x1},\Varid{x2}),\Varid{l}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}f_2 \mathrel{=}\Varid{substCell}\comp (\conj{\p1}{\uncurry{\Varid{toCell}}}\times\Varid{id}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{substCell}\;(((\Varid{r},\Varid{c}),\Varid{move}),\Varid{h})\;\Varid{m}{}\<[E]%
\\
\>[6]{}\hsindent{30}{}\<[36]%
\>[36]{}\mid (\Varid{m}\mathbin{!!}\Varid{c})\mathbin{!!}\Varid{r}\equiv \Conid{Blocked}\mathrel{=}\Varid{h}\;\Varid{m}{}\<[E]%
\\
\>[6]{}\hsindent{30}{}\<[36]%
\>[36]{}\mid \Varid{otherwise}\mathrel{=}\Varid{subst}\;(\Varid{subst}\;\Varid{move}\;\Varid{r}\;(\Varid{h}\;\Varid{m}\mathbin{!!}\Varid{c}))\;\Varid{c}\;(\Varid{h}\;\Varid{m}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{16}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 reconst}\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{16}{}\<[16]%
\>[16]{}\mid \length \;\Varid{l}\leq \mathrm{1}\mathrel{=}\map \;\p1\;(\Varid{pairL}\;\Varid{l})\equiv \map \;\p2\;(\Varid{pairL}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{16}{}\<[16]%
\>[16]{}\mid \Varid{otherwise}\mathrel{=}\Varid{init}\;\Varid{l}\equiv \map \;\p1\;(\Varid{pairL}\;\Varid{l})\mathrel{\wedge}\Varid{tail}\;\Varid{l}\equiv \map \;\p2\;(\Varid{pairL}\;\Varid{l}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{propriedade}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 extr2}\;\Varid{l}\;\Varid{m}\mathrel{=}\mathbf{if}\;(\length \;\Varid{l}\mathbin{>}\mathrm{1}\mathrel{\wedge}\Varid{isValidMap}\;\Varid{m})\;\mathbf{then}\;\Varid{checkCell}\;(\Varid{init}\;\Varid{l})\;(\Varid{markMap}\;\Varid{l}\;\Varid{m})\;\mathbf{else}\;\Conid{False}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{checkCell}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{m}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{checkCell}\;((\Varid{x},\Varid{y})\mathbin{:}\Varid{t})\;\Varid{m}\mathrel{=}((\Varid{m}\mathbin{!!}\Varid{y})\mathbin{!!}\Varid{x})\not\equiv \Conid{Free}\mathrel{\wedge}\Varid{checkCell}\;\Varid{t}\;\Varid{m}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
