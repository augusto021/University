...
int main (int argc, char* argv[]) {
    ...
    if (argv[2][1] == 'm') { // Condição para testar se foi chamado apenas um módulo.
        if (argv[3][0] == 'f' || argv[3][1] == 'f') moduloA(file_name, default_size, force_RLE);
        else if (argv[3][0] == 't' || argv[3][1] == 't') moduloB(file_name);
        else if (argv[3][0] == 'c' || argv[3][1] == 'c') moduloC(file_name);
        else if (argv[3][0] == 'd' || argv[3][1] == 'd') moduloD(file_name,descm_RLE,descm_SF);
    }
